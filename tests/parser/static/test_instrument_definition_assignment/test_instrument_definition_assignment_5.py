...
prog_5 = """
__device__ double fun1();
__device__ double fun2();
__device__ double fun3();
__device__ void comp(double *x) {
  double y=fun1(), z=fun2(), k=fun3();
  x[0] = (y=fun1(), z=fun2(), k=fun3(), y) + 3.1;
}
"""
...
def test_1():
  ...
  assert inst_program(prog_5, 'prog_5', 0)
